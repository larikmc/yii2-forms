...
class FormModalWidget extends Widget
{
    ...
    public function run(): string
    {
        ...
        $formHtml = FormWidget::widget(['slug'=>$this->slug,'template'=>$this->formTemplate,'view'=>$this->formView,'formOptions'=>$this->formOptions,'showHeading'=>false,'showDescription'=>true]);
...
.forms-modal{position:fixed;inset:0;z-index:9999;display:none;}
...
.forms-modal__body{padding:18px 22px 22px;}
