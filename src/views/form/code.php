...
<div class="sz-panel">
    ...
    <div class="sz-ui-kit-grid forms-ui-grid">
        <section class="sz-panel sz-ui-kit-panel">
            ...
            <pre id="code1" class="sz-ui-kit-code"><code><?= Html::encode("<?= \\larikmc\\forms\\widgets\\FormWidget::widget(['slug' => '{$model->slug}']) ?>") ?></code></pre>
        ...
        <section class="sz-panel sz-ui-kit-panel">
            ...
            <pre id="code2" class="sz-ui-kit-code"><code><?= Html::encode("<?= \\larikmc\\forms\\widgets\\FormWidget::widget(['slug' => '{$model->slug}', 'template' => 'default']) ?>") ?></code></pre>
            <div class="sz-ui-kit-actions">
        ...
        <section class="sz-panel sz-ui-kit-panel">
            ...
            <pre id="code3" class="sz-ui-kit-code"><code><?= Html::encode("<?= \\larikmc\\forms\\widgets\\FormModalWidget::widget(['slug' => '{$model->slug}', 'buttonLabel' => 'Оставить заявку']) ?>") ?></code></pre>
            <div class="sz-ui-kit-actions">
        ...
        <section class="sz-panel sz-ui-kit-panel">
            ...
            <pre id="code4" class="sz-ui-kit-code"><code><?= Html::encode("<?= \\larikmc\\forms\\widgets\\FormModalWidget::widget(['slug' => '{$model->slug}', 'buttonLabel' => 'Оставить заявку', 'formTemplate' => 'default', 'modalTemplate' => 'default']) ?>") ?></code></pre>
            <div class="sz-ui-kit-actions">
